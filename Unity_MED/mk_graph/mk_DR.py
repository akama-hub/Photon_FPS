...
for motion in motions:
    ...
    p2 = plt.plot(delay, lr_diff, linestyle = "--", dashes = (2, 2), marker=markers[4], color = colors[2], markerfacecolor = "None", ms = marker_size)
    p3 = plt.plot(delay, nlr_diff, linestyle = "--", dashes = (3, 3), marker='+', color = colors[3], markerfacecolor = "None", ms = marker_size)
    p4 = plt.plot(delay, dr_diff, linestyle = "--", dashes = (4, 4), marker='x', color = colors[1], markerfacecolor = "None", ms = marker_size)
    p5 = plt.plot(delay, maadr_diff, linestyle = "--", dashes = (5, 5), marker=markers[2], color = "grey", markerfacecolor = "None", ms = marker_size)
    p6 = plt.plot(delay, mlp_diff, linestyle = "--", dashes = (6, 6), marker=markers[3], color = "orange", markerfacecolor = "None", ms = marker_size)
