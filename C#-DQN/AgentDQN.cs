...
public class AgentDQN : MonoBehaviour
{
    ...
    public AgentDQN(int batch_capacity, int batch_size, int updater, int input_size, int hidden_size, int output_size, float learning_rate, float max_grad_norm, float gamma,
    float epsilon, float decay, float min_decay)  
    {
